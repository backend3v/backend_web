...
def register_prompt_routes(app, getResponse):
    ...
    def prompt():
        ...
        try:
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                future_news = executor.submit(scraper.get_news, prompt_text)
                future_image = executor.submit(scraper.get_image, prompt_text)
                news_result = future_news.result()
                image_result = future_image.result()
            bito_result['news'] = news_result
            bito_result['image'] = image_result
    ...
    def prompt_history():
        ...
        # Traer los prompts ordenados por fecha descendente
